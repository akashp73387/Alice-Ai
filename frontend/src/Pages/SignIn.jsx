    ...
    >
      ...
      <div className="relative z-10 flex max-w-5xl w-full bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl shadow-2xl overflow-hidden">
        {!isMobile && (
          <div className="hidden md:flex md:w-1/2 flex-col items-center justify-center p-10 text-white">
            <div className="text-center mb-8">
              <img src={alicedark} alt="Bot Logo" className="rounded-full object-cover" />
              <p className="text-lg text-zinc-200 mt-1   text-justify">
                Alice AI is your intelligent Conversational AI ChatBot, designed to streamline 
                workplace technology tasks and enhance the digital employee experience. 
                Powered by advanced AI Capabilities, Alice AI delivers instant solutions, 
                be it executing tasks, answering questions and helping with IT Self services
              </p>
            </div>
        ...
        <div className="w-full md:w-1/2 p-8 md:p-10 bg-black/40">
          ...
          <h2 className="text-3xl font-bold text-center text-white mb-1 hidden lg:block md:block">Welcome Back</h2>
          <p className="text-center text-gray-50 mb-8">Sign in to unlock smarter conversations.</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              <label className="block text-sm font-medium text-gray-50 mb-1">Username</label>
            ...
            <div>
              <label className="block text-sm font-medium text-gray-50 mb-1">Password</label>
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                ...
                />
                <label htmlFor="remember-me" className="ml-2 block text-sm text-gray-50">Remember me</label>
              </div>
            </div>
